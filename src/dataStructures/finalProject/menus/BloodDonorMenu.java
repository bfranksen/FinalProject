...
public class BloodDonorMenu {
            ...
            while (true) {
                try {
                    if (Utils.doubleCheck(updatedPatient, "update")) {
                        ...
                        System.out.print("1. Eligibility to donate blood " + ConsoleColors.CYAN + "(Currently " + eligible + ")\n\t" + ConsoleColors.RESET);
                        System.out.print("2. Willingness to donate blood " + ConsoleColors.CYAN + "(Currently " + willing + ")\n\t" + ConsoleColors.RESET);
                        ...
                        if (response < 1 || response > 3) {
                            ...
                            updateEligAndWill(updatedPatient, response);
                        }
                    } else {
                        System.out.println(ConsoleColors.YELLOW + "\n\tNo changes have been made.");
                        updatedPatient = null;
    ...
    private void updateEligAndWill(Patient patient, int response) {
                    ...
                    if (response < 1 || response > 5) {
                        ...
                        switch (response) {
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                System.out.println(ConsoleColors.CYAN + "Search for:\n\t" + ConsoleColors.RESET +
    ...
    public String askForPatientBloodType(String message) {
        String bloodType = "";
        int response;
